# Django settings for TaskOrganizer project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'taskorganizer',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'ke5&g$kjxy^0=eu=^#y)+ij#q-5iiq_6(w-r$8ll!c%s=6j2b('
...
ROOT_URLCONF = 'TaskOrganizer.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'TaskOrganizer.wsgi.application'
