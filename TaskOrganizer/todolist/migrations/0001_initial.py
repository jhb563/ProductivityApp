...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'todolist_project', (
            ...
            ('parentid', self.gf('django.db.models.fields.IntegerField')(default=-1)),
            ('finished', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'todolist', ['Project'])
        ...
        db.create_table(u'todolist_task', (
            ...
            ('deadline', self.gf('django.db.models.fields.DateTimeField')()),
            ('date_finished', self.gf('django.db.models.fields.DateTimeField')()),
            ('parent_project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['todolist.Project'])),
            ('finished', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'todolist_project')
