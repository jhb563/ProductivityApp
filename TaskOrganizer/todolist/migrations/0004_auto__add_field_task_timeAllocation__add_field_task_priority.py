...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.timeAllocation'
        db.add_column(u'todolist_task', 'timeAllocation',
    ...
    def backwards(self, orm):
        # Deleting field 'Task.timeAllocation'
        db.delete_column(u'todolist_task', 'timeAllocation')
